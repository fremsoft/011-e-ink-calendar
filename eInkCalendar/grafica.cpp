...
void printBattery() {
  // immaginando che l'andamento sia lineare
  const int ADC_MIN = 1600;  // 1584 minimo valore rilevato prima di spegnersi
  const int ADC_MAX = 2250;  // 2293 massimo valore rilevato al 100%
